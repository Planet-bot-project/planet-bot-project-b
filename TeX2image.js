...
const worker = new Worker('./TeX2image_worker.js');

function worker_on_msg(obj) {
	if (obj.msg === '') {
...
client.on('messageCreate', (msg) => {
	...
	if (msg.content === '!!ping') {
	...
	} else if (msg.content.startsWith('!!TeX')) {
		...
		msg.reply(
			'コマンドが認識されませんでした。!!helpでコマンド一覧を確認してください。',
		);
	}
});
